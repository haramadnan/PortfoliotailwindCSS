  ...
  return (
    ...
    <div className='space-y-8'>
        <div className='flex flex-col gap-1' data-aos="zoom-in-down">
            ...
            <input type='text' 
            className='h-[40px] bg-blue-100 border border-accent'
            id='name'/>
        </div>
        <div className='flex flex-col gap-1' data-aos="zoom-in-down">
        ...
        <div className='flex flex-col gap-1' data-aos="zoom-in-down">
            ...
            <textarea  
            className=' bg-blue-100 border border-accent'
            id='msg' rows={8}>
            </textarea>
    </div>
    <button className='bg-blue-100 p-2 px-6' data-aos="zoom-in-down">Send</button>
    </div>
    </div>
    </div>
  )
